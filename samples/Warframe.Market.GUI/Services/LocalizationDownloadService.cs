...
/// </summary>
public class LocalizationDownloadService : ILocalizationDownloadService
{
    ...
    public LocalizationDownloadService(HttpClient http, string? localesDir = null)
    {
        _http = http;
        _localesDir = localesDir ?? LocalesDir;
    }
    ...
    {
        return File.Exists(Path.Combine(_localesDir, $"{language}.json"));
    }
}
