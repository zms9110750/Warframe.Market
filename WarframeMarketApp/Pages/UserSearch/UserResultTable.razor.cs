...
public partial class UserResultTable : ComponentBase
{
	...
	protected override void OnInitialized()
	{
		_headers = new()
		{
			new("物品", nameof(Order.Id)) { Sortable = false, ValueExpression = (Func<Order, object?>)(o => SortName(o)) },
			new("英文名称", nameof(Order.Id)) { Sortable = false, ValueExpression = (Func<Order, object?>)(o => SortEn(o)) },
			...
			new("参考价", nameof(Order.Id)) { Sortable = false, ValueExpression = (Func<Order, object?>)(o => SortRef(o)) },
			new("差价", nameof(Order.Id)) { Sortable = false, ValueExpression = (Func<Order, object?>)(o => SortDiff(o)) },
		};
	}
